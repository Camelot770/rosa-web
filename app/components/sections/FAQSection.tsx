...
const faqs: Array<{ q: string; a: string }> = [
  {
    ...
    a: 'Это натуральные растения, прошедшие специальную обработку: природный сок замещён безопасным раствором на&nbsp;основе пищевого глицерина. В&nbsp;результате цветы сохраняют естественный вид, гибкость и&nbsp;текстуру на&nbsp;годы&nbsp;— без воды и&nbsp;ухода.',
  },
  {
    q: 'Чем они отличаются от сухоцветов?',
    a: 'Сухоцветы полностью обезвожены&nbsp;— они хрупкие и&nbsp;ломкие. Стабилизированные цветы остаются эластичными, выглядят живыми, не&nbsp;осыпаются. Внешним видом и&nbsp;тактильными ощущениями не&nbsp;отличаются от&nbsp;свежесрезанных цветов.',
  },
  {
