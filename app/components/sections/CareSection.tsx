...
const rules = [
  {
    ...
    d: 'Лепестки сохраняют упругость и&nbsp;тактильную мягкость. Их можно касаться без хруста и&nbsp;осыпания.',
  },
  {
    n: '02',
    t: (
    ...
    d: 'В&nbsp;основе технологии&nbsp;— растительные соки, пищевой глицерин и&nbsp;натуральные пигменты. Без формальдегидов.',
  },
  {
    n: '03',
    t: (
    ...
    d: 'Настоящие срезанные цветы. Каждый стебель и&nbsp;лист&nbsp;— живой материал, остановленный во&nbsp;времени.',
  },
];
