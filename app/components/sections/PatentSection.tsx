...
const items: PatentItem[] = [
  ...
  },
  {
    ...
    text:
      'Сертификат соответствия требованиям экологической безопасности. Стабилизирующий состав на&nbsp;основе глицерина и&nbsp;натуральных растительных пигментов.',
  },
  {
    code: 'LAB',
        ...
        <div className="patent-head">
          ...
          <R delay={150}>
            <p className="patent-lead">
              ...
              сертификат. Срок жизни подтверждён протоколом испытаний. Имя закреплено
              зарегистрированным товарным знаком. Четыре документа за&nbsp;каждым букетом&nbsp;—
              поэтому он живёт у&nbsp;вас годами, а&nbsp;не&nbsp;неделями.
            </p>
          </R>
        </div>
