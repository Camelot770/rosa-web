          ...
          <article className="legal-doc">
            <section>
              ...
              <p>
                ...
                смесь натуральных растительных соков, глицерина и&nbsp;пищевых пигментов.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Технология стабилизации цветов, мха и&nbsp;растений разработана российской компанией
                <strong> «Эйлат»</strong> и&nbsp;запатентована в&nbsp;Российской Федерации&nbsp;—
                <strong> патент RU&nbsp;№&nbsp;2&#8202;698&#8202;058</strong>.
              </p>
              <p>
                Состав раствора, температурный режим, время выдержки&nbsp;— всё определено
                и&nbsp;стандартизировано. Студия «Роза Цветов» работает по&nbsp;этой технологии
