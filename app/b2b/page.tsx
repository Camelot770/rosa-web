          ...
          <article className="legal-doc">
            <section>
              ...
              <ul>
                ...
                <li>
                  <strong>Подарки коллективу.</strong> Сотрудникам к&nbsp;корпоративным праздникам,
                  юбилеям работы, 8 марта, дням рождения, выходу из&nbsp;декрета. Готовим набор
                  одинаковых композиций или подбираем индивидуально по&nbsp;списку.
                </li>
                <li>
                ...
                <li>
                  <strong>Композиции под&nbsp;заказ.</strong> Уникальная авторская работа под
                  конкретный повод&nbsp;— ключевой партнёр, юбилей, событийный подарок.
                  Согласовываем эскиз, палитру, сорта роз, размеры и&nbsp;кашпо.
                </li>
                <li>
            ...
            <section>
              ...
              <ul>
                <li>
                  <strong>Брендированные вазы и&nbsp;кашпо</strong>&nbsp;— керамика с&nbsp;логотипом
                  или&nbsp;фирменным паттерном, печать прямо на&nbsp;поверхности;
                </li>
                ...
                <li>упаковка (коробки, тубусы) с&nbsp;тиснением или&nbsp;печатью.</li>
              </ul>
            </section>
