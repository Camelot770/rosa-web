        ...
        <div className="legal-container">
          ...
          <article className="legal-doc">
            ...
            <section>
              ...
              <p>
                Вы можете забрать букет в&nbsp;удобное время по&nbsp;адресу:
              </p>
              <div className="info-block" style={{ marginBottom: 16 }}>
                <p>
                  <strong>422772, Республика Татарстан, Пестречинский район,
                  д.&nbsp;Званка, ул.&nbsp;Приозерная, д.&nbsp;58</strong>
                </p>
                <p style={{ fontSize: 13, color: 'var(--ink-soft)', marginTop: 8 }}>
                  Точное время приезда согласует менеджер по&nbsp;телефону после
